              ...
              <table class="table datatable">
				...
				%>
				    <tr>
				        ...
				        <td><%= s.getPrice() %></td>
				        <td>
				            <button type="button" class="btn btn-sm btn-info view-btn" data-object-id="<%= s.getService_id() %>"  id="openModalViewBtn">
				                <i class="bi bi-eye"></i> View
				            </button>
				            <button type="button" class="btn btn-sm btn-danger delete-btn" data-object-id="<%= s.getService_id() %>" id="openModalDelBtn">
      ...
      <div class="card">
        <div class="card-body">
          ...
          <form action="addService" method="post">
            ...
            <div class="row mb-3">
              <label for="inputMobile" class="col-sm-2 col-form-label">Price</label>
              <div class="col-sm-10">
                <input type="tel" class="form-control" id="inputPrice" name="price">
              </div>
            </div>
            <div class="row mb-3">
		  ...
		  <div class="modal-content small-modal">
		    <div class="card">
		      <div class="card-body">
		        ...
		        <div class="text-center">
		          <form action="delService" method="post" class="d-inline">
  ...
  document.querySelectorAll('.delete-btn').forEach(function(button) {
	    button.addEventListener('click', function() {
	    	showModal('myModalDel')
	 	    document.getElementById('service_id').value=this.getAttribute('data-object-id');
	    });
	  });
  
  document.querySelectorAll('.view-btn').forEach(function(button) {
    button.addEventListener('click', function() {
      var serviceId = this.getAttribute('data-object-id');
      window.location.href = "editServiceForm.jsp?serviceId=" + serviceId;
    });
  });
