  ...
  <main id="main" class="main">
    ...
    <section class="section dashboard">
      <div class="row">
			    ...
			    <div class="card-body">
			      ...
			      <script>
			        document.addEventListener("DOMContentLoaded", () => {
			          let genderData = <%= cf.getCountOfGender(null) %>;
			...
			<div class="col-lg-6">
			    <div class="card">
			        <div class="card-body">
			            <h5 class="card-title">By Group Age</h5>
			            ...
			            <script>
			                document.addEventListener("DOMContentLoaded", () => {
			                    ...
			                    const ageGroupData = <%= cf.getCountOfAgeGroup(null)%>;
    ...
    <div class="row">
    	<div class="pagetitle">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">By Number of Booking</h5>
              ...
              <script>
		      document.addEventListener("DOMContentLoaded", () => {
		        const data = <%= ((BookingScheduleFunctionImpl) bf).getBookingCountByMonth() %>;
		
		        const monthYearData = data.map(item => item.month_year);
