...
<body>
 ...
 <aside id="sidebar" class="sidebar">
      ...
      <li class="nav-item">
        <a class="nav-link" href="Position.jsp">
            ...
            <div class="card-body">
              ...
              <table class="table datatable">
                ...
                <%
				    ...
				    for (PositionObject c : list) {
				%>
				    <tr>
				        <td><%= c.getPosition_id() %></td>
				        <td><%= c.getPosition_name() %></td>
				        <td>
				            <button type="button" class="btn btn-sm btn-info view-btn" data-object-id="<%= c.getPosition_id() %>"  id="openModalViewBtn">
				                <i class="bi bi-eye"></i> View
				            </button>
				            <button type="button" class="btn btn-sm btn-danger delete-btn" data-object-id="<%= c.getPosition_id() %>" id="openModalDelBtn">
		  ...
		  <div class="modal-content small-modal">
		    <div class="card">
		      <div class="card-body">
		        ...
		        <div class="text-center">
		          <form action="delPosition" method="post" class="d-inline">
		            <input type="hidden" id="position_id_del" name="position_id_del" value="0">
  ...
  document.querySelectorAll('.delete-btn').forEach(function(button) {
	    button.addEventListener('click', function() {
	    	showModal('myModalDel')
	 	    document.getElementById('position_id_del').value=this.getAttribute('data-object-id');
	    });
	  });
  
  document.querySelectorAll('.view-btn').forEach(function(button) {
    button.addEventListener('click', function() {
      var positionId = this.getAttribute('data-object-id');
      window.location.href = "editPositionForm.jsp?positionId=" + positionId;
    });
  });
