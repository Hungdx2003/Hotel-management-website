          ...
          <div class="card">
            <div class="card-body">
              ...
              <table class="table datatable">
                ...
                <tbody>  
                <%
                	ArrayList<BookingSchedule> list = bsf.getAllSchedule(null);
				    for (BookingSchedule b : list) {
				%>
                  <tr>
                    <td><%= b.getBooking_id() %></td>
                    <td><%= b.getCustomer_fullname() %></td>
                    <td><%= b.getRoomNumber() %></td>
                    <td><%= b.getCheck_in_date() %></td>
                    <td><%= b.getCheck_out_date() %></td>
                    <td><%= b.getStatus() %></td>
                    <td>
                      <button type="button" class="btn btn-sm btn-info view-btn" data-object-id="<%= b.getBooking_id() %>" >
                        <i class="bi bi-eye"></i> View
                      </button>
                      <button type="button" class="btn btn-sm btn-success order-btn" data-object-id="<%= b.getBooking_id() %>" >
                        <i class="bi bi-eye"></i> Order
                      </button>
                    </td>
                  </tr>
                <%
...
<%}else{ %>
  ...
  document.querySelectorAll('.view-btn').forEach(function(button) {
    button.addEventListener('click', function() {
      var bookingId = this.getAttribute('data-object-id');
      window.location.href = "editBookingForm.jsp?bookingId=" + bookingId;
    });
  });
  ...
  document.querySelectorAll('.order-btn').forEach(function(button) {
	    button.addEventListener('click', function() {
	      var bookingId = this.getAttribute('data-object-id');
	      window.location.href = "serviceRequestForm.jsp?bookingId=" + bookingId;
	    });
	  });
